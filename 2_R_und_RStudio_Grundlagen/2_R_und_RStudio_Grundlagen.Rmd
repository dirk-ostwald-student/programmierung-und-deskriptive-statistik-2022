...
knitr::include_graphics("2_Abbildungen/pds_2_otto.png")
```
...
knitr::include_graphics("2_Abbildungen/pds_2_r_download.png")
```
...
```{r, echo = FALSE, out.width = "80%"}
knitr::include_graphics("2_Abbildungen/pds_2_rstudio_download.png")
```
...
knitr::include_graphics("2_Abbildungen/pds_2_rstudio.png")
```
...
knitr::include_graphics("2_Abbildungen/pds_2_using_rstudio.png")
```
...
knitr::include_graphics("2_Abbildungen/pds_2_rstudio_datascienceuniverse.pdf")
```
...
```{r, echo = FALSE, out.width = "80%"}
knitr::include_graphics("2_Abbildungen/pds_2_lehrmaterialien.pdf")
```
...
```{r, echo = FALSE, out.width = "70%"}
knitr::include_graphics("2_Abbildungen/pds_2_precedence.pdf")
```
...
\vfill
```{r, echo = FALSE, out.width = "90%"}
knitr::include_graphics("2_Abbildungen/pds_2_workspace.pdf")
```
\vfill
...
knitr::include_graphics("2_Abbildungen/pds_2_binding_1.pdf")
```
\vspace{1mm}
...
```{r, echo = FALSE, out.width="22%"}
knitr::include_graphics("2_Abbildungen/pds_2_binding_2.pdf")
```
\vspace{1mm}
...
```{r, echo = FALSE, out.width="70%"}
knitr::include_graphics("2_Abbildungen/pds_2_copy_on_modify.pdf")
```
...
knitr::include_graphics("2_Abbildungen/pds_2_unbinding.pdf")
```
\vspace{-2mm}
\small
Unbinding
...
```{r, echo = FALSE, out.width="80%"}
knitr::include_graphics("2_Abbildungen/pds_2_r_objektstruktur.pdf")
```
